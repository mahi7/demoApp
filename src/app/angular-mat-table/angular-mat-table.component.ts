...
@Component({
  selector: 'app-angular-mat-table',
  templateUrl: './angular-mat-table.component.html',
  styleUrls: ['./angular-mat-table.component.css']
})
export class AngularMatTableComponent implements AfterViewInit {
